...
.. _triqs__det_manip__det_manip__inverse_matrix_internal_order:
...
**Synopsis**
 ...
 .. rst-class:: cppsynopsis
    ...
    1. | det_manip::value_type :red:`inverse_matrix_internal_order` (int :param:`i`, int :param:`j`) const

    2. | det_manip::matrix_const_view_type :red:`inverse_matrix_internal_order` () const

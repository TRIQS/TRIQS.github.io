...
**Synopsis**
 ...
 .. rst-class:: cppsynopsis
    ...
    1. | :green:`template<typename L, typename G>`
       | block2_gf_view<Var, Target> & :red:`operator=` (lazy_transform_t<L, G> const & :param:`rhs`)

    2. | void :red:`operator=` (mpi_lazy<tag::reduce, block2_gf_view<Var, Target>::const_view_type> :param:`l`)

...
+-------------------------------------------------------------------------------------------------+--+
| :ref:`(constructor) <triqs__mc_tools__mc_generic__constructor>`                                 |  |
+-------------------------------------------------------------------------------------------------+--+
| :ref:`add_move <triqs__mc_tools__mc_generic__add_move>`                                         |  |
+-------------------------------------------------------------------------------------------------+--+
| :ref:`add_measure <triqs__mc_tools__mc_generic__add_measure>`                                   |  |
+-------------------------------------------------------------------------------------------------+--+
| :ref:`add_measure_aux <triqs__mc_tools__mc_generic__add_measure_aux>`                           |  |
+-------------------------------------------------------------------------------------------------+--+
| :ref:`rm_measure <triqs__mc_tools__mc_generic__rm_measure>`                                     |  |
+-------------------------------------------------------------------------------------------------+--+
| :ref:`set_after_cycle_duty <triqs__mc_tools__mc_generic__set_after_cycle_duty>`                 |  |
+-------------------------------------------------------------------------------------------------+--+
| :ref:`warmup <triqs__mc_tools__mc_generic__warmup>`                                             |  |
+-------------------------------------------------------------------------------------------------+--+
| :ref:`accumulate <triqs__mc_tools__mc_generic__accumulate>`                                     |  |
+-------------------------------------------------------------------------------------------------+--+
| :ref:`warmup_and_accumulate <triqs__mc_tools__mc_generic__warmup_and_accumulate>`               |  |
+-------------------------------------------------------------------------------------------------+--+
| :ref:`collect_results <triqs__mc_tools__mc_generic__collect_results>`                           |  |
+-------------------------------------------------------------------------------------------------+--+
...
+---------------------------------------------------------+--+
| :ref:`h5_write <triqs__mc_tools__mc_generic__h5_write>` |  |
+---------------------------------------------------------+--+
| :ref:`h5_read <triqs__mc_tools__mc_generic__h5_read>`   |  |
+---------------------------------------------------------+--+

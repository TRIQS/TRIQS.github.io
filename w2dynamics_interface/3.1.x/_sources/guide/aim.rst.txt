...
:red:`This section is exactly the same as in the documentation of triqs_cthyb:`

`An example: the Anderson impurity model <https://triqs.github.io/cthyb/master/guide/aim.html>`_
